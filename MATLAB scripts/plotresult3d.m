...
xlabel('Iteration')
ylabel('Stage')
title({'Stage index';'1=Feasibility stage, 2=Optimization stage,3=Global exploration stage'})
ylim([0 4])
drawnow
...
SV_final(:,3) = SV_standardized(:,3)*SVMModel.Sigma(3) + SVMModel.Mu(3);
...
yPred_surf0con = reshape(Score(:,2), 10, 10, 10);
yPred_surf0obj = reshape(yPredobj, 10, 10, 10);
