function [A,B]=platt_Basudhar(out,target,prior0,prior1,dpos,dneg)
...
Bm = dneg./(dpos+1e-10) - dpos./(dneg+1e-10);  %vector of the same size as out and target
